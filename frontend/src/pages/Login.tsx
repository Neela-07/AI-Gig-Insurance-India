      ...
      >
        <div className="bg-white/5 backdrop-blur-2xl border border-white/10 rounded-3xl p-8 shadow-[0_0_40px_-10px_rgba(99,102,241,0.2)]">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-white mb-2">SmartShield AI</h1>
            <p className="text-gray-400 text-sm text-center">
              Next-generation parametric insurance for the modern gig economy.
            </p>
          </div>
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="admin@smartshield.ai or worker@..."
                  required
                />
              </div>
            </div>
          ...
          <div className="mt-8 text-center border-t border-white/5 pt-6">
            <p className="text-xs text-gray-500 mb-4">
              Demo Credentials:<br/>
              <span className="text-indigo-400">worker@smartshield.ai</span> (Standard)<br/>
              <span className="text-indigo-400">admin@smartshield.ai</span> (Admin)
            </p>
